...
export class IPFSService {
  ...
  private async encrypt(content: string): Promise<string> {
    ...
    // In production, use proper encryption library like crypto-js or node-forge
  ...
  private async decrypt(content: string): Promise<string> {
    ...
    const encrypted = content.replace('ENCRYPTED:', '');
...
<body>
  <div class="certificate">
    ...
    <div class="field">
      ...
      <div class="value">
        <a href="https://amoy.polygonscan.com/tx/${data.transactionHash}" target="_blank">
    ...
    <div class="field">
      ...
      <div class="value">${data.network === 'amoy' ? 'Polygon Amoy Testnet' : 'Polygon Mainnet'}</div>
    </div>

    <div class="footer">
      <p>This certificate proves that an API request was made and its response was recorded immutably on the blockchain.</p>
      <p>Generated by PROOF Protocol • <a href="https://proof-protocol.io">proof-protocol.io</a></p>
